...
float lastFrame = 0.0f;      // Время вывода последнего кадра
...
int main()
{
    ...
    // =================
    GLFWwindow *mainWindow = glfwCreateWindow(WIDTH, HEIGHT, "Test Graphics window", NULL, NULL);
    if (!mainWindow)
    {
    ...
    Shader lightingShader = Shader("resources/shaders/lighting.vs", "resources/shaders/lighting.frag");
    Shader lampShader = Shader("resources/shaders/lamp.vs", "resources/shaders/lamp.frag");
...
//    std::string texturePath = "resources/images/container2.png";
//    FileSystem::getPath("resources/images/container2.png");
